...
class MiApp(QtWidgets.QMainWindow):
    ...
    def m_productos(self):
        ...
        for row in datos:
            rowS = str(row[5])
            self.ui.tabla_productos.setItem(
            ...
            self.ui.tabla_productos.setItem(
                tablerow, 4, QtWidgets.QTableWidgetItem(rowS))
            tablerow += 1
    ...
    def insert_productos(self):
        ...
        self.datosTotal.inserta_producto(
    ...
    def modificar_productos(self):
        ...
        if nombreXX != None:
            ...
            act = self.datosTotal.actualiza_productos(
                codigoM, nombreM, modeloM, precioM, cantidadM)
            if act == 1:
    ...
    def buscar_producto(self):
        ...
        for row in datosB:
            ...
            self.ui.tabla_buscar.setItem(
                tablerow, 3, QtWidgets.QTableWidgetItem(row[4]))
            self.ui.tabla_buscar.setItem(
                tablerow, 4, QtWidgets.QTableWidgetItem(row[5]))
            tablerow += 1
